...
public class BookService {
    ...
    public List<Book> findBookByCategory(String category){
        ...
        if (books==null){
            throw new ApiException("there is no Book with this category");
        }
    ...
    public List<Book> findBooksOver300(){
        ...
        if (books==null){
            throw new ApiException("there is no Book with more than 300 pages");
        }
        return books;
    }
    ...
    public List<Book> findBookByAuthor(String author){
        ...
        if (books==null){
            throw new ApiException("there is no Book with this Author");
        }
    ...
    public List<Book> findBookByTitle(String title){
        ...
        if (books==null){
            throw new ApiException("there is no book with this title");
        }
